...
public class WhatsappContactsManagerModule extends ReactContextBaseJavaModule {
    public static final String NAME = "WhatsappContactsManager";

    public WhatsappContactsManagerModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
